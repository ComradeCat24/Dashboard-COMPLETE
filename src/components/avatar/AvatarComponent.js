		...
		return (
			<div
				className={classnames(
					`avatar ${
						this.props.color ? `bg-${this.props.color}` : null
					}  ${this.props.className}`,
					{
						"avatar-sm":
							this.props.size && this.props.size === "sm",
						"avatar-lg":
							this.props.size && this.props.size === "lg",
						"avatar-xl":
							this.props.size && this.props.size === "xl",
					}
				)}
			>
				{this.props.img === false || this.props.img === undefined ? (
					...
					<img
						...
						width={
							this.props.imgWidth && !this.props.size
								? this.props.imgWidth
								: 32
						}
					/>
				...
				{this.props.status ? (
					<span
						className={`avatar-status-${this.props.status}`}
					></span>
				) : null}
			</div>
		);
